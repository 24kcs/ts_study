...
<html lang="en-US">
  <head>
    ...
    <title>5. 泛型 | TypeScript 快速上手</title>
    <meta name="description" content="尚硅谷前端研究院">
    <meta name="generator" content="VuePress 1.3.0">
    
    
    <link rel="preload" href="/ts_study/assets/css/0.styles.d833c323.css" as="style"><link rel="preload" href="/ts_study/assets/js/app.9b1c1622.js" as="script"><link rel="preload" href="/ts_study/assets/js/2.a1a6c2fe.js" as="script"><link rel="preload" href="/ts_study/assets/js/14.dd972ea4.js" as="script"><link rel="prefetch" href="/ts_study/assets/js/10.b114daa4.js"><link rel="prefetch" href="/ts_study/assets/js/11.a6e5dfa6.js"><link rel="prefetch" href="/ts_study/assets/js/12.7425353d.js"><link rel="prefetch" href="/ts_study/assets/js/13.463cf109.js"><link rel="prefetch" href="/ts_study/assets/js/15.d3f5a1ac.js"><link rel="prefetch" href="/ts_study/assets/js/16.543dbcff.js"><link rel="prefetch" href="/ts_study/assets/js/17.236d503e.js"><link rel="prefetch" href="/ts_study/assets/js/18.7de1921d.js"><link rel="prefetch" href="/ts_study/assets/js/19.e2e0ec76.js"><link rel="prefetch" href="/ts_study/assets/js/3.906ccf9c.js"><link rel="prefetch" href="/ts_study/assets/js/4.0fd64b2c.js"><link rel="prefetch" href="/ts_study/assets/js/5.0a08b5a2.js"><link rel="prefetch" href="/ts_study/assets/js/6.bd105e14.js"><link rel="prefetch" href="/ts_study/assets/js/7.263fcd07.js"><link rel="prefetch" href="/ts_study/assets/js/8.d95412e2.js"><link rel="prefetch" href="/ts_study/assets/js/9.33290923.js">
...
</code></pre></div><h2 id="使用函数泛型"><a href="#使用函数泛型" class="header-anchor">#</a> 使用函数泛型</h2> <div class="language-typescript extra-class"><pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token generic-function"><span class="token function">createArray2</span> <span class="token generic class-name"><span class="token operator">&lt;</span><span class="token constant">T</span><span class="token operator">&gt;</span></span></span> <span class="token punctuation">(</span>value<span class="token operator">:</span> <span class="token constant">T</span><span class="token punctuation">,</span> count<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre></div><h2 id="泛型接口"><a href="#泛型接口" class="header-anchor">#</a> 泛型接口</h2> <p>在定义接口时, 为接口中的属性或方法定义泛型类型<br>
在使用接口时, 再指定具体的泛型类型</p> <div class="language-typescript extra-class"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">IbaseCRUD <span class="token operator">&lt;</span><span class="token constant">T</span><span class="token operator">&gt;</span></span> <span class="token punctuation">{</span>
...
</code></pre></div><h2 id="泛型类"><a href="#泛型类" class="header-anchor">#</a> 泛型类</h2> <p>在定义类时, 为类中的属性或方法定义泛型类型
在创建类的实例时, 再指定特定的泛型类型</p> <div class="language-typescript extra-class"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">GenericNumber<span class="token operator">&lt;</span><span class="token constant">T</span><span class="token operator">&gt;</span></span> <span class="token punctuation">{</span>
...
</code></pre></div><h2 id="泛型约束"><a href="#泛型约束" class="header-anchor">#</a> 泛型约束</h2> <p>如果我们直接对一个泛型参数取 <code>length</code> 属性, 会报错, 因为这个泛型根本就不知道它有这个属性</p> <div class="language-typescript extra-class"><pre class="language-typescript"><code><span class="token comment">// 没有泛型约束</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>我们可以使用泛型约束来实现</p> <div class="language-typescript extra-class"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Lengthwise</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>我们需要传入符合约束类型的值，必须包含必须 <code>length</code> 属性：</p> <div class="language-typescript extra-class"><pre class="language-typescript"><code><span class="token function">fn2</span><span class="token punctuation">(</span><span class="token string">'abc'</span><span class="token punctuation">)</span>
<span class="token comment">// fn2(123) // error  number没有length属性</span>
</code></pre></div></div> <footer class="page-edit"><!----> <!----></footer> <div class="page-nav"><p class="inner"><span class="prev">
      ←
      <a href="/ts_study/chapter2/4_function.html" class="prev">
        4. 函数
      </a></span> <span class="next"><a href="/ts_study/chapter2/6_other.html">
        6. 其它
      </a>
      →
    </span></p></div> </main></div><div class="global-ui"></div></div>
    <script src="/ts_study/assets/js/app.9b1c1622.js" defer></script><script src="/ts_study/assets/js/2.a1a6c2fe.js" defer></script><script src="/ts_study/assets/js/14.dd972ea4.js" defer></script>
  </body>
</html>
